...
│   ├── constants                   # Constants (alerts, colors, etc)
│   ├── lib                         # Libraries
│   ├── pages                       # Next JS Pages
│   ├── pages.test                  # Next JS Pages tests (this avoid test to treated as a Next.js pages)
│   ├── services                    # Services (animations)
│   │   ├─ api                        APIs services (extends HttpService)
...
Deploy this on Vercel in one click:

[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/git/external?repository-url=https%3A%2F%2Fgitlab.com%2Fconexa-projects%2Fsendinblue%2Ffrontend)
